const _widgets= [
  ...
  { "id":"SM-04","label":"Body Image",  "type":"SM",    "constraint":{}, "sel":false,"selindex":-1,  "cancertype":[  {id:0},{id:2}],
  ...
  { "id":"SM-06","label":"Chemo and Fertility",  "type":"SM",    "constraint":{}, "sel":false,"selindex":-1,  "cancertype":[  {id:0},{id:2}],
          "instruments":[   { name:"Chemo and Fertility",description: "Fertility Impact", value: 1, "modulecount": 6, "bwpoints": 2}]},
  { "id":"SM-07","label":"Advance Directive", "type":"SM",    "constraint":{}, "sel":false,"selindex":-1,  "cancertype":[  {id:1}],
