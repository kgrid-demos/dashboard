const _widgets= [
  { "id":"PRO-01","label":"Pain", "type":"PRO",  "constraint":{}, "sel":false, "selindex":-1,"cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  ,{ "id":"PRO-02","label":"Anxiety", "type":"PRO", "constraint":{}, "sel":false,"selindex":-1, "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  ,{ "id":"PRO-03","label":"Depression", "type":"PRO",    "constraint":{}, "sel":false,"selindex":-1, "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-04","label":"Nausea & Vomiting",  "type":"PRO",    "constraint":{}, "sel":false,"selindex":-1, "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-05","label":"Nerve Pain & Tingling", "type":"PRO",    "constraint":{}, "sel":false,"selindex":-1, "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-06","label":"Palm & Sole Rash", "type":"PRO",    "constraint":{}, "sel":false,"selindex":-1, "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-07","label":"Fatigue",  "type":"PRO",    "constraint":{}, "sel":false,"selindex":-1, "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-08","label":"Mouth Sores", "type":"PRO",    "constraint":{}, "sel":false,"selindex":-1,  "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-09","label":"Body Weight", "type":"PRO",    "constraint":{}, "sel":false,"selindex":-1,  "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-10","label":"Drinking Fluids",  "type":"PRO",    "constraint":{}, "sel":false,"selindex":-1, "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-11","label":"Ostomy Output", "type":"PRO",    "constraint":{}, "sel":false,"selindex":-1, "cancertype":[ {id:1}],
  ...
  { "id":"PRO-12","label":"Temperature & Fever", "type":"PRO",    "constraint":{}, "sel":false,"selindex":-1, "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-13","label":"Appetite",  "type":"PRO",    "constraint":{}, "sel":false, "selindex":-1, "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-14","label":"Fertility", "type":"PRO",    "constraint":{}, "sel":false,"selindex":-1, "cancertype": [ {id:0},{id:2}],
    "instruments":[ { name: "Visual Analog Scale (VAS)", value: 1, "bwpoints":14,
                      "dow":["Su","Mo","Tu","We","Th","Fr","Sa"], "range":{min:0,max:100,inc:1,step:20},
  ...
  { "id":"PRO-15","label":"Exercise", "type":"PRO",    "constraint":{}, "sel":false,"selindex":-1, "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"SM-01","label":"Colon Cancer Nutrition & Fluids", "type":"SM",    "constraint":{}, "sel":false,"selindex":-1,  "cancertype":[ {id:1}],
  ...
  { "id":"SM-02","label":"Colon Cancer & Self Image",  "type":"SM",    "constraint":{}, "sel":false,"selindex":-1,"cancertype":[  {id:1}],
          "instruments":[  { name:"Colon Cancer & Self Image",description: "Self-image self management", value: 1, "modulecount": 4, "bwpoints": 1}]},
  { "id":"SM-03","label":"Ostomy Care", "type":"SM",    "constraint":{}, "sel":false,"selindex":-1,"cancertype":[ {id:1}],
          "instruments":[  { name:"Ostomy Care",description: "Ostomy Care", value: 1, "modulecount": 4, "bwpoints": 2}]},
  { "id":"SM-04","label":"Body Image",  "type":"SM",    "constraint":{}, "sel":false,"selindex":-1,  "cancertype":[  {id:0},{id:1},{id:2}],
          "instruments":[   { name:"Body Image",description: "Self Image / Body Image", value: 1, "modulecount": 4, "bwpoints": 2}]},
  { "id":"SM-05","label":"Family Talk About Cancer Risk", "type":"SM",    "constraint":{}, "sel":false,"selindex":-1,  "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"SM-06","label":"Chemo and Fertility",  "type":"SM",    "constraint":{}, "sel":false,"selindex":-1,  "cancertype":[  {id:0},{id:1},{id:2}],
          "instruments":[   { name:"Chemo and Fertility",description: "Fertility Impact", value: 1, "modulecount": 6, "bwpoints": 2}]},
  { "id":"SM-07","label":"Advance Directive", "type":"SM",    "constraint":{}, "sel":false,"selindex":-1,  "cancertype":[ {id:0},{id:1},{id:2}],
          "instruments":[  { name:"Advance Directive",description: "End of Life/Advance Directive", value: 1, "modulecount": 1, "bwpoints": 0} ]},
  { "id":"SM-08","label":"Sexual Health",  "type":"SM",    "constraint":{}, "sel":false,"selindex":-1,  "cancertype":[  {id:0}, {id:1},{id:2}],
          "instruments":[  { name:"Sexual Health",description: "Sexual Health", value: 1, "modulecount": 4, "bwpoints": 1} ]},
  { "id":"TRO-01","label":"Temperature", "type":"TRO",    "constraint":{}, "sel":false, "selindex":-1,  "cancertype":[  {id:99}],
          "instruments":[ { name: "Temperature in Fahrenheit", value: 1, "bwpoints":14,
  ...
  { "id":"TRO-04","label":"Humidity", "type":"TRO",    "constraint":{}, "sel":false, "selindex":-1,"cancertype":[  {id:99}],
          "instruments":[ { name: "Relative Humidity", value: 1, "bwpoints":14,
                      "dow":["Su","Mo","Tu","We","Th","Fr","Sa"], "range":{min:0,max:100,inc:1,step:20},
                      "unit":" %", "ryg":[{min:0,max:29,color:"orange"}, {min:30,max:59, color:"green"}, {min:60,max:100,color:"red"}]} ]},
  { "id":"TRO-02","label":"Wind Speed", "type":"TRO",    "constraint":{}, "sel":false, "selindex":-1,"cancertype":[  {id:99}],
          "instruments":[ { name: "Wind Speed in miles/hour", value: 1, "bwpoints":14,
                    "dow":["Su","Mo","Tu","We","Th","Fr","Sa"], "range":{min:0,max:100,inc:1,step:20},
                    "unit":" Mile/Hour", "ryg":[{min:0,max:4,color:"green"}, {min:5,max:19, color:"orange"}, {min:20,max:100,color:"red"}]} ]},
  { "id":"TRO-03","label":"Precipitation", "type":"TRO",    "constraint":{}, "sel":false, "selindex":-1,"cancertype":[  {id:99}],
          "instruments":[ { name: "Precipition in inches", value: 1, "bwpoints":14,
  ...
  { "id":"TRS-01","label":"Tornado Safety",  "type":"TRS",    "constraint":{}, "sel":false,"selindex":-1, "cancertype":[  {id:99}],
