const _widgets= [
  { "id":"PRO-01","label":"Pain", "type":"PRO",  "constraint":{}, "sel":false,
  ...
  { "id":"PRO-02","label":"Anxiety", "type":"PRO",    "constraint":{}, "sel":false,
    "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-03","label":"Depression", "type":"PRO",    "constraint":{}, "sel":false,
    "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-04","label":"Nausea & Vomitting",  "type":"PRO",    "constraint":{}, "sel":false,
  "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-05","label":"Nerve Pain & Tingling", "type":"PRO",    "constraint":{}, "sel":false,
  "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-06","label":"Palm & Sole Rash", "type":"PRO",    "constraint":{}, "sel":false,
  "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-07","label":"Fatigue",  "type":"PRO",    "constraint":{}, "sel":false,
  "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-08","label":"Mouth Sores", "type":"PRO",    "constraint":{}, "sel":false,
  "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-09","label":"Body Weight", "type":"PRO",    "constraint":{}, "sel":false,
  "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-10","label":"Drinking Fluids",  "type":"PRO",    "constraint":{}, "sel":false,
  "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-11","label":"Ostomy Output", "type":"PRO",    "constraint":{}, "sel":false,
  "cancertype":[ {id:1}],
  ...
  { "id":"PRO-12","label":"Temperature & Fever", "type":"PRO",    "constraint":{}, "sel":false,
  "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"PRO-14","label":"Fertility", "type":"PRO",    "constraint":{}, "sel":false,
  ...
  { "id":"PRO-15","label":"Exercise", "type":"PRO",    "constraint":{}, "sel":false,
  "cancertype":[  {id:0}, {id:1},{id:2}],
  ...
  { "id":"SM-01","label":"Colon Cancer Nutrition & Fluids", "type":"SM",    "constraint":{}, "sel":false,
  "cancertype":[ {id:1}],
  "instruments":[ { name:"Colon Cancer Nutrition & Fluids",description: "Nutrition support and oral hydration", value: 1, "modulecount": 3, "bwfreq": 1}]},
  { "id":"SM-02","label":"Conlon Cancer & Self Image",  "type":"SM",    "constraint":{},
  "cancertype":[  {id:1}],
  "instruments":[  { name:"Conlon Cancer & Self Image",description: "Self-image self management", value: 1, "modulecount": 4, "bwfreq": 1}]},
  { "id":"SM-03","label":"Ostomy Care", "type":"SM",    "constraint":{}, "sel":false,
  "cancertype":[ {id:1}],
  "instruments":[  { name:"Ostomy Care",description: "Ostomy Care", value: 1, "modulecount": 4, "bwfreq": 2}]},
  { "id":"SM-04","label":"Body Image",  "type":"SM",    "constraint":{}, "sel":false,
  "cancertype":[  {id:0},{id:2}],
  "instruments":[   { name:"Body Image",description: "Self Image / Body Image", value: 1, "modulecount": 4, "bwfreq": 2}]},
  { "id":"SM-05","label":"Family Talk About Cancer Risk", "type":"SM",    "constraint":{}, "sel":false,
  "cancertype":[  {id:0}, {id:1},{id:2}],
  "instruments":[  { name:"Family talk about cancer risk",description: "Familial risk discussions with adult and children", value: 1, "modulecount": 1, "bwfreq": 0}]},
  { "id":"SM-06","label":"Chemo and Fertility",  "type":"SM",    "constraint":{}, "sel":false,
  "cancertype":[  {id:0},{id:2}],
  "instruments":[   { name:"Chemo and Fertility",description: "Fertility Impact", value: 1, "modulecount": 6, "bwfreq": 2}]},
  { "id":"SM-07","label":"Advance Directive", "type":"SM",    "constraint":{}, "sel":false,
  "cancertype":[  {id:1}],
  "instruments":[  { name:"Advance Directive",description: "End of Life/Advance Directive", value: 1, "modulecount": 1, "bwfreq": 0} ]},
  { "id":"SM-08","label":"Sexual Health",  "type":"SM",    "constraint":{}, "sel":false,
  "cancertype":[  {id:0}, {id:1},{id:2}],
  "instruments":[  { name:"Sexual Health",description: "Sexual Health", value: 1, "modulecount": 4, "bwfreq": 1} ]}
                        ]
